...
FabData      =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.eyepeatv.2/',''))
...
def SpeedChoice():
    ...
    if choice == 0:
        xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.eyepeatv.2/speedtest.py")')
    if choice == 1:
        xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.eyepeatv.2/fastload.py")')
