...
def peamenyy(params):
    ...
    plugintools.addItem('[COLOR orange][B]Eye Pea TV [/COLOR][COLOR grey]NORMAL[/COLOR] [COLOR orange]Service[/B][/COLOR]','speed',7654,GoDev.Images + 'logo.png',GoDev.Images + 'background.png')
