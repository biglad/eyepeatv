...
def peamenyy(params):
    ...
    if channels == 1 and GoDev.mode != 5 and GoDev.mode != 1:
        ...
        plugintools.addItem('[COLOR orange][B]Free Preview[/B][/COLOR](please note this is now as stable as the paid service!!!!)','speed',9876,GoDev.Images + 'logo.png',GoDev.Images + 'background.png')        
        ##quit()
