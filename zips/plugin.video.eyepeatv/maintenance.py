...
addonPath = os.path.join(os.path.join(xbmc.translatePath('special://home'), 'addons'),'plugin.video.eyepeatv')
...
def clearCache():
    ...
    dialog = xbmcgui.Dialog()
    xbmc.executebuiltin('Notification(Clean,[COLOR white]Cache cleaned[/COLOR],2000,special://home/addons/plugin.video.eyepeatv/icon.png)')
...
def deleteThumbnails():
    ...
    try:
        ...
        pass
	xbmc.executebuiltin("Container.Refresh")
	xbmc.executebuiltin('Notification(Clean,[COLOR white]Thumbnails cleaned[/COLOR],2000,special://home/addons/plugin.video.eyepeatv/icon.png)')
        ...
        for root, dirs, files in os.walk(purgePath):
            ...
            if file_count > 0:            
                ...
                for d in dirs:
                    shutil.rmtree(os.path.join(root, d))
                dialog = xbmcgui.Dialog()
                xbmc.executebuiltin('Notification(Purged,[COLOR white]All packages purged[/COLOR],2000,special://home/addons/plugin.video.eyepeatv/icon.png)')
            else:
                dialog = xbmcgui.Dialog()
                xbmc.executebuiltin('Notification(Not Required,[COLOR white]No Packages to Purge[/COLOR],2000,special://home/addons/plugin.video.eyepeatv/icon.png)')
	xbmc.executebuiltin("Container.Refresh")
...
def autocleannow():
    ...
    xbmc.executebuiltin('Notification(Clean,[COLOR white]All temporary data has been cleaned[/COLOR],2000,special://home/addons/plugin.video.eyepeatv/icon.png)')
    xbmc.executebuiltin("Container.Refresh")