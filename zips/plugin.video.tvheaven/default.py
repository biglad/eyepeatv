import urllib,urllib2,re,xbmcplugin,xbmcgui,sys,xbmc,xbmcaddon,os,json,time
import requests
...
def pickserver():
    import random
    #servers = ['https://watchepisodeseries.unblocked.mx','http://watchepisodeseries.unblockall.org/']
...
Altserver = "http://www.watchepisodeseries.com/" # "http://watchepisodeseries.unblockall.org/"
CurrentServer = Altserver
def CATEGORIES():
