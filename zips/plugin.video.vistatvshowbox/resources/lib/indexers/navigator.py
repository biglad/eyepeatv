...
class navigator:
    ...
    def movies(self, lite=False):
        self.addDirectoryItem('[COLOR green]Click Here to Pair[/COLOR] - (Do this once every 4 hours)', 'pair', 'icon.png', 'DefaultFolder.png')
...
#        self.addDirectoryItem(32073, 'authTrakt', 'trakt.png', 'DefaultAddonProgram.png')
        ...
        self.addDirectoryItem(32078, 'openscrapersettings', 'lambda.png', 'DefaultAddonProgram.png')
