...
from vistascrapers.modules import jsunpack, cleantitle
...
class source:
    def __init__(self):
        ...
        self.base_link = 'https://w1.cmovieshd.bz'
        self.tv_link = 'https://w1.cmovieshd.bz/tv-series/'
        self.movie_link = 'https://w1.cmovieshd.bz/movie/'
        self.search_link = 'https://w1.cmovieshd.bz/search/?q='
