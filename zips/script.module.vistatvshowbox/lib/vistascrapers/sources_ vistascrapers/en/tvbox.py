...
from vistascrapers.modules import cleantitle,client,source_utils,dom_parser
...
class source:
    def __init__(self):
        ...
        self.base_link = 'https://tvbox.fux0r.top/'
        self.search_link = 'search?q=%s'
        self.search_link_movie = 'https://tvbox.fux0r.top/movies'
