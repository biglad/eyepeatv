...
class source:
    def __init__(self):
        ...
        self.base_link = 'https://watchtvseries.unblockall.org'
        self.search_link = 'https://watchtvseries.unblockall.org/show/search-shows-json'
        self.search_link_2 = 'https://watchtvseries.unblockall.org/search/%s'
