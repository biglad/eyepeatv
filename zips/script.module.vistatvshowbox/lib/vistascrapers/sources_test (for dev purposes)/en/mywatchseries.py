...
class source:
    def __init__(self):
        ...
        self.base_link = 'http://watchtvseries.unblckd.club/'
        self.search_link = 'http://watchtvseries.unblckd.club/show/search-shows-json'
        self.search_link_2 = 'http://watchtvseries.unblckd.club/search/%s'
