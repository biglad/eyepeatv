...
from vistascrapers.modules import dom_parser2 as dom
...
class source:
    def __init__(self):
        ...
        self.base_link = 'https://lime1.unblocked.is'
        self.tvsearch = 'https://lime1.unblocked.is/search/tv/{0}/'
        self.moviesearch = 'https://lime1.unblocked.is/search/movies/{0}/'
