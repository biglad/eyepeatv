...
class source:
    ...
    def __init__(self):
        ...
        self.api_key = xbmcaddon.Addon('script.module.vistatvshowbox').getSetting('pm.pin')    #PremiumizeMeResolver.get_setting('password')
        self.tvsearch = 'https://torrentapi.org//pubapi_v2.php?app_id=cove&mode=search&search_string=%s&category=tv&ranked=0&token=%s'
        self.msearch = 'https://torrentapi.org//pubapi_v2.php?app_id=cove&mode=search&search_string=%s&category=movies&ranked=0&token=%s'
        self.tokenta = 'https://torrentapi.org//pubapi_v2.php?app_id=cove&get_token=get_token'
