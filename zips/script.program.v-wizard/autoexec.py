...
xbmcgui.Dialog().notification("[COLOR=red]VistaTV[/COLOR]", "PLEASE WAIT!!!!")
def killkodi():
    xbmcgui.Dialog().notification("[COLOR=red]VistaTV[/COLOR]", "UPDATE DONE CLOSING KODI")
    xbmc.sleep(5000)
...
def main():
    class enableAll():
        def __init__(self):
            ...
            #xbmc.sleep(2000)
            #xbmcgui.Dialog().notification("[COLOR=red]VistaTV[/COLOR]", "ENABLE BOTH INPUT PLAYER SETTINGS YOU HAVE 30 SECONDS")
            dialog.ok("[COLOR=red][B]INFORMATION[/COLOR][/B]", "ENABLE!!!", "[COLOR=yellow]BOTH PLAYER INPUT SETTINGS??","These need to be on for best playback[/COLOR]")
            xbmc.executebuiltin('ActivateWindow(10040,"addons://user/kodi.inputstream",return)')
            xbmc.sleep(1000)
            
            
            while xbmc.getCondVisibility("Window.IsActive(10040)"):
                xbmcgui.Dialog().notification("[COLOR=red]VistaTV[/COLOR]", "[COLOR=yellow]ENABLE BOTH INPUT PLAYER SETTINGS AND GO BACK TO MAIN MENU!!![/COLOR]")
                xbmc.sleep(4000)
                
            xbmc.executebuiltin("ActivateWindow(10000)")    
            #dialog.ok("[COLOR=red][B]INFORMATION[/COLOR][/B]", "HAVE YOU ENABLED", "BOTH PLAYER INPUT SETTINGS??","These need to be on for best playback")
    ...
    try:
        xbmcgui.Dialog().notification("[COLOR=red]VistaTV[/COLOR]", "Checking Add-ons")
        firstRun = enableAll()
        xbmcgui.Dialog().notification("[COLOR=red]VistaTV[/COLOR]", "All Addons Enabled")
        xbmcvfs.delete('special://userdata/autoexec.py')
    except Exception, e:
        xbmcgui.Dialog().notification("[COLOR=red]VistaTV[/COLOR]", "Error Check LogFile")
        xbmc.log(str(e), xbmc.LOGERROR)
        xbmcvfs.delete('special://userdata/autoexec.py')
        

    old_file = os.path.join(xbmc.translatePath('special://userdata/'), 'updated.xml')
    new_file = os.path.join(xbmc.translatePath('special://userdata/'), 'guisettings.xml')
    xbmcvfs.delete('special://userdata/guisettings.xml')

    #xbmc.sleep(5000)
    #xbmc.executebuiltin("ReloadSkin()")
    xbmc.sleep(5000)
    dp = xbmcgui.DialogProgress()
    xbmcgui.Dialog().notification("[COLOR=red]VistaTV[/COLOR]", "Sorting Layout Please Wait")
    dp.create("[COLOR tomato]VistaTV[/COLOR]","Sorting Layout Please Wait","This Will Take approx 30 secs")
    xbmc.sleep(5000)
    ...
    dp.create("[COLOR tomato]VistaTV[/COLOR]","Sorting Layout Please Wait","This Will Take approx 30 secs")
    xbmc.sleep(5000)
    xbmcgui.Dialog().notification("[COLOR=red]VistaTV[/COLOR]", "SAVING CHANGES!!!! PLEASE WAIT.... CLOSING!!!!")
    dp.create("[COLOR tomato]VistaTV[/COLOR]","SAVING CHANGES!!!!","PLEASE WAIT.... CLOSING!!!!")
    xbmc.sleep(5000)
    xbmcgui.Dialog().notification("[COLOR=red]VistaTV[/COLOR]", "SAVING CHANGES!!!! PLEASE WAIT.... CLOSING!!!!")
    dp.create("[COLOR tomato]VistaTV[/COLOR]","SAVING CHANGES!!!!","PLEASE WAIT.... CLOSING!!!!")
    xbmc.sleep(5000)
