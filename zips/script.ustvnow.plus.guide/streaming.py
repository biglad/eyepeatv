...
class StreamsService(object):
    def __init__(self, addon):
        path = xbmc.translatePath(os.path.join('special://profile', 'addon_data', 'script.ustvnow.plus.guide', 'addons.ini'))
        xbmc.log('[script.ustvnow.plus.guide] FTV addons.ini is used', xbmc.LOGDEBUG)
