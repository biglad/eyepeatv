...
def function2():
    ...
    dialog = xbmcgui.Dialog()
    dp.create("[COLOR gold]EyePeaTV House Keeper[/COLOR]","Removing temp /old files","Please Wait...")
    xbmc.sleep(2000)
    dp.update(10)
    ...
    MZip9     = xbmc.translatePath('special://home/userdata/Database/Epg12.db')
    #THUMBS
    ...
    dp.update(100)
    dp.close()
    dp.create("[COLOR gold]EyePeaTV House Keeper[/COLOR]","Closing Kodi","Please Wait...")
    dp.update(100)
    xbmc.sleep(3000)
    os._exit(1)
