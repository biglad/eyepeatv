...
def menuoptions():
    ...
    '[B][COLOR=gold]      Download[/COLOR] Kodi 18.0[/B] For Android 5+', #2
    '[B][COLOR=green]      Download[/COLOR] Free VPN[/B] For Android 5+', #3
    '[B][COLOR=green]      Download[/COLOR] VistaTV Launcher[/B] For All Android', #4
...
def function19():
    opensite = webbrowser . open('https://36.rdeb.io/d/46T7Q5TEDUNRO/BlueStacks2_native_961a341e0a52e83c0c0231556a1487e5.exe')
